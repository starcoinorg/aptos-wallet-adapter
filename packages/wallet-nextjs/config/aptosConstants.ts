...
export const TEST_NODE_URL = 'https://fullnode.testnet.aptoslabs.com/v1';
export const TEST_FAUCET_URL = 'https://faucet.testnet.aptoslabs.com';

export const NODE_URL = TEST_NODE_URL;
export const FAUCET_URL = TEST_FAUCET_URL;
